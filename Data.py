...
🔰Click on the button below which GoaGame game prediction you want...👇
    ...
    # GoaGame Button
    goagame_buttons = [
        [InlineKeyboardButton(text="[►Wingo 1 Minute◄]", callback_data="ggwingo")],   
        [InlineKeyboardButton(text="[►Return All Games◄]", callback_data="allgame")],
    ]
    # GoaGame Back Button
    goagame_back = [
...
Enter the last 3 digits of the period number with the /OkWinWingo command.
...
Enter the last 3 digits of the period number with the /LuckNowWingo command.
...
🔰Click on the button below which tiranga game prediction you want...👇
    ...
    # tiranga Button
    tiranga_buttons = [
        [InlineKeyboardButton(text="[►Wingo 1 Minute◄]", callback_data="tirangawingo")],   
        [InlineKeyboardButton(text="[►Return All Games◄]", callback_data="allgame")],
    ]
    # tiranga Back Button
    tiranga_back = [
